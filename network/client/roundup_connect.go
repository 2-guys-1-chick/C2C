...
func RoundupConnect(loadedIp []net.IP, packetHandler network.PacketHandler, disconnectHandler network.DisconnectHandler, onNewConnection func(c net.Conn)) error {
